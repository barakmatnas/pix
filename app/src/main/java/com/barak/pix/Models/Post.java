...
public class Post {
    ...
    public Post(Author author, String full_url, String full_storage_uri, String thumb_url, String thumb_storage_uri, String text, Object timestamp ,Double lat,Double lon) {
        this.author = author;
