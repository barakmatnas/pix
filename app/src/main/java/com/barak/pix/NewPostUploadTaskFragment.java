...
import com.barak.pix.Models.Author;
import com.barak.pix.Models.Post;
...
public class NewPostUploadTaskFragment extends Fragment {
    ...
    public void uploadPost(Bitmap bitmap, String inBitmapPath, Bitmap thumbnail, String inThumbnailPath,
                           String inFileName, String inPostText,Double lat,Double lon) {
        UploadPostTask uploadTask = new UploadPostTask(bitmap, inBitmapPath, thumbnail, inThumbnailPath, inFileName, inPostText, lat, lon);
        uploadTask.execute();
    }
                    ...
                    thumbnailRef.putBytes(thumbnailStream.toByteArray())
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            Post newPost = new Post(author, fullSizeUrl.toString(), fullSizeRef.toString(),
                                    thumbnailUrl.toString(), thumbnailRef.toString(), postText, ServerValue.TIMESTAMP,latitude,longitude);
