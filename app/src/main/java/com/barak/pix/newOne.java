...
public class newOne extends FragmentActivity {
    ...
    private class CustomInfoWindowAdapter implements InfoWindowAdapter {
        ...
        public View getInfoContents(Marker marker) {
            ...
            if (newOne.this.marker != null
                    && newOne.this.marker.isInfoWindowShown()) {
                newOne.this.marker.hideInfoWindow();
                newOne.this.marker.showInfoWindow();
            }
            return null;
        }
